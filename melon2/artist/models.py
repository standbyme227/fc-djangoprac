...
class Artist(models.Model):
    ...
    real_name = models.CharField('본명', max_length=100, blank=True)
    nationality = models.CharField('국적', max_length=50, blank=True)
    birth_date = models.CharField('생일', max_length=50, null=True, blank=True)
    constellation = models.CharField('별자리', max_length=50, blank=True)
